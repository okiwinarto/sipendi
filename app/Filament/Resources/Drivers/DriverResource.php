...
class DriverResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Sopir Dinas';

    protected static ?string $modelLabel = 'Sopir Dinas';

    protected static ?string $pluralModelLabel = 'Sopir Dinas Pool';
